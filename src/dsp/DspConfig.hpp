...
inline constexpr float maxAutoHeadroomDb = 2.5f;
inline constexpr float autoHeadroomFreeBoostDb = 12.0f;
inline constexpr float autoHeadroomTotalBoostRatio = 0.08f;
inline constexpr float autoHeadroomPeakBoostRatio = 0.10f;
...
inline constexpr float defaultLimiterCeilingDb = 0.0f;
inline constexpr float defaultLimiterCeilingLinear = 1.0f;
