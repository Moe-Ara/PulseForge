...
inline constexpr float maxEffectiveEqGainDb = 8.0f;
inline constexpr float maxTotalPositiveEqBoostDb = 18.0f;
inline constexpr float insignificantGainDb = 0.01f;
inline constexpr float maxAutoHeadroomDb = 12.0f;
inline constexpr float autoHeadroomFreeBoostDb = 0.0f;
inline constexpr float autoHeadroomTotalBoostRatio = 0.22f;
inline constexpr float autoHeadroomPeakBoostRatio = 0.35f;
...
inline constexpr float limiterReleaseMs = 55.0f;
